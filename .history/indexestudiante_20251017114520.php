...
<style>
/* Estilo adicional para horario desplegable */
#horarioGrupo { display: none; margin-top: 30px; }
</style>
</head>
<body>
...
<section class="mis-cursos my-5">
  ...
  <div class="docentes-grid">
    ...
    <div class="estudiante-card">
      ...
      <button id="btnVerHorario" class="boton w-100 text-center">Ver Horario</button>
    </div>
...
<!-- SECCIÓN HORARIO DEL ESTUDIANTE POR DÍAS -->
...
<script>
document.getElementById('btnVerHorario').addEventListener('click', function() {
    let seccion = document.getElementById('horarioGrupo');
