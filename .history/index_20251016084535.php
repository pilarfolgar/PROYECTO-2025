...
<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="imagenes/piso1.jpeg" class="d-block w-100" alt="Piso 1">
    </div>
    <div class="carousel-item">
...
<!-- ---------------- INSCRIPCIONES ---------------- -->
<section class="text-center py-4 bg-light border-bottom">
  <h3 class="text-primary fw-bold">📅 Inscripciones 2026</h3>
  <p class="mb-0 small">
    A partir del <strong>15/12</strong> dirígete con tu <strong>cédula</strong>, 
    <strong>carnet de adolescente al día</strong>, 
    <strong>carnet de vacunas</strong> y <strong>$200 para Siet</strong>.
  </p>
</section>
    ...
    <div class="col-md-6">
      <div class="p-3 border rounded shadow-sm bg-white">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              <td>Bachillerato Tecnológico en Tecnologías de la Información Bilingüe</td>
              <td>3 años</td>
              <td>Matutino/Vespertino</td>
            </tr>
            <tr>
              <td>Bachillerato Tecnológico en Tecnologías de la Información</td>
              <td>3 años</td>
              <td>Matutino/Vespertino</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Secretariado Bilingüe - Inglés</td>
              <td>2 años</td>
              <td>Nocturno</td>
            </tr>
            <tr>
              <td>Curso Técnico Terciario de Diseño Gráfico en Comunicación Visual</td>
              <td>2 años</td>
              <td>Nocturno</td>
            </tr>
            <tr>
              <td>Tecnólogo en Ciberseguridad</td>
              <td>3 años</td>
              <td>Nocturno</td>
            </tr>
            <tr>
              <td>Curso Técnico Terciario en Redes y Comunicaciones Ópticas</td>
              <td>2 años</td>
              <td>Nocturno</td>
            </tr>
          </tbody>
