...
// Asignar correctamente según rol
$docente_cedula   = ($rol === 'docente') ? $cedula_emisor : 0;
...
if($id_grupo && $titulo && $mensaje && $cedula_emisor){
    ...
    $sql = "INSERT INTO notificaciones 
            (id_grupo, docente_cedula, adscripto_cedula, titulo, mensaje, fecha, visto_estudiante, visto_adscripto, rol_emisor, fecha_expiracion)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
header("Location: ".($rol == 'docente' ? "indexdocente.php" : "indexadministrativo.php"));
exit();
?>
